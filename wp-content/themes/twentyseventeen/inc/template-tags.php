...
//	}
	...
	$tags_list = get_the_tag_list( $separate_meta );
        ...
        if ( $categories_list ) {
							...
							echo '<div class="entry-cf"><div class="post-categories">' . $categories_list . '</div></div>';
                                              ...
                                              //  echo '<ul><li><a class="url fn n" href="' . esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ) . '">' . get_the_author() . '</a></li></ul>';

                                                if ( $tags_list ) {

							echo '<div class="entry-cf"><div class="tag">' . $tags_list . '</div></div>';
	...
	return sprintf(
		...
		__( '<div class="entry-cf"><ul><li><span class="screen-reader-text">Posted on</span> %s', 'twentyseventeen' ),

		'<a href="' . esc_url( get_permalink() ) . '" rel="bookmark">' . $time_string . '</a></li></ul></div>'
